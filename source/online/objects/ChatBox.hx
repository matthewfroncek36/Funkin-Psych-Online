...
class ChatBox extends FlxTypedSpriteGroup<FlxSprite> {
	...
	final accept:String = Controls.instance.mobileControls ? "RETURN" : "ACCEPT";
	final tab:String = Controls.instance.mobileControls ? "C" : "TAB";
    ...
    override function update(elapsed) {
		...
		if (MusicBeatState.getState()?.mobileButtonJustPressed('C') == true || FlxG.keys.justPressed.TAB) {
			focused = !focused;
